...
if __name__ == '__main__':
	...
	operations = [
		...
		["PrefireUncUp",MergeUncPreFireCorrelated,options.sigDir,options.sms,yearsToMerge,RunLumi,"prefireuncUp",MergedNominal,True],
		["PrefireUncDown",MergeUncPreFireCorrelated,options.sigDir,options.sms,yearsToMerge,RunLumi,"prefireuncDown",MergedNominal,False],
